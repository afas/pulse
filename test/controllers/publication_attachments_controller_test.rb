...
class PublicationAttachmentsControllerTest < ActionController::TestCase
  ...
  test "should create publication_attachment" do
    assert_difference('PublicationAttachment.count') do
      post :create, publication_attachment: { image: @publication_attachment.image, publication_id: @publication_attachment.publication_id, title: @publication_attachment.title }
    end
  ...
  test "should update publication_attachment" do
    patch :update, id: @publication_attachment, publication_attachment: { image: @publication_attachment.image, publication_id: @publication_attachment.publication_id, title: @publication_attachment.title }
    assert_redirected_to publication_attachment_path(assigns(:publication_attachment))
  end
